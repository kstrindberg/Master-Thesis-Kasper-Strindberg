...
grid_limit 'Desired max power from grid kW' /300/
;
...
execute_unload 'EVCS_15_F1.gdx' var_grid_power, var_grid_energy, var_ESS_size, var_ESS_power, var_ess_rated_power,
...
execute_unload "EVCS_15_F1"
execute "gdx2sqlite -i EVCS_15_F1.gdx -o EVCS_15_F1_results.db"
