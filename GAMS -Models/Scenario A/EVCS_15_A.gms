*Define scalars
scalar battery_cost 'Cost of Li-Oin battery NOK/kWh' /432/
...
execute_unload 'EVCS_15_A.gdx' var_grid_power, var_grid_energy, var_ESS_size, var_ESS_power, var_ess_rated_power,
...
execute_unload "EVCS_15_A"
execute "gdx2sqlite -i EVCS_15_A.gdx -o EVCS_15_A_results.db"
